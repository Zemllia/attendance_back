...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    avatar = models.ImageField(upload_to='diplomv/user_avatars/', null=True, blank=True, verbose_name='Фото', default='/diplomv/user_avatars/default_avatar.png')
    uuid = models.CharField('UUID', max_length=255)
    my_events = models.ManyToManyField('Event', related_name='my_events', verbose_name='События пользователя', null=True)
